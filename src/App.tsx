    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ bgcolor: "#1976d2" }}>
        <Toolbar>
          ...
          <Button color="inherit" startIcon={<Analytics />} onClick={() => setCurrentView('analysis')}>
            分析
          </Button>
          <Button color="inherit" startIcon={<Settings />} onClick={() => setCurrentView('settings')}>
            設定
          </Button>
        </Toolbar>
      </AppBar>
        ...
        {currentView === 'analysis' && (
          <Card>
            <CardContent>
              ...
              <Box sx={{ mb: 2 }}>
                <Button 
                  variant={groupBy === 'merchant' ? 'contained' : 'outlined'}
                ...
                <Button 
                  variant={groupBy === 'category' ? 'contained' : 'outlined'}
      ...
      {/* 広告バナー */}
      <AdBanner placementId="main_banner" />
